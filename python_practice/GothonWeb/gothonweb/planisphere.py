...
tell the one Gothon joke you know: Lbhe zbhure vf fb sng, jura fur fvgf
...
code to get the bomb out. If you get the code wrong ten times then the
...
generic_death = Room("death", quips[randint(0, 4)])
